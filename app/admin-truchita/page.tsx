...
export default function AdminTruchita() {
  ...
  const addProduct = (section: MenuSection) => {
    ...
    setDraft((current) => ({ ...current, products: [...current.products, { id, section, name: 'NUEVO ESQUITE', price: 0, description: 'Describe aquí lo que lleva.', image: '/esquite-callejero.png', hasIngredients: section === 'specialty' }] }));
  };
