...
function CheckoutForm({ customer, setCustomer, onSubmit, onBack }: { customer: { name: string; phone: string; address: string; references: string }; setCustomer: (value: { name: string; phone: string; address: string; references: string }) => void; onSubmit: (event: FormEvent<HTMLFormElement>) => void; onBack: () => void }) {
