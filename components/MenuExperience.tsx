...
export default function MenuExperience() {
  ...
  return <main className="menu-page">
    ...
    <section className="menu menu-only" id="menu" aria-labelledby="menu-title">
      <div className="menu-lead"><p className="section-kicker light">ARMA TU VASO, A TU GUSTO</p><h1 id="menu-title">EL MENÚ<br /><em>ESTÁ CALIENTE.</em></h1><div className="menu-lead-side"><figure className="menu-photo"><img src="/esquite-callejero.png" alt="Vaso de esquites al carbón con chile, queso y limón" /><figcaption>HECHOS AL MOMENTO · SOLO A DOMICILIO</figcaption></figure><p>Cada esquite se prepara al momento. Elige tus ingredientes, revisa su foto de referencia y déjanos tu nota.</p></div></div>
